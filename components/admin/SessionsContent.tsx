      ...
      {activeTab === 'create' && (
        <div className="tab-content">
          <div className="create-session-card">
            ...
            <div className="form-group"><label>Descrição</label><textarea maxLength={255}  value={newSession.description} onChange={(e) => setNewSession({...newSession, description: e.target.value})} placeholder="Descrição detalhada da sessão" rows={3}/></div>
